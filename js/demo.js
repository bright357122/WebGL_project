...
scene.fog=new THREE.FogExp2( 0xcce0ff, 0.04 );
...
floor.receiveShadow = false; //default
	scene.add(floor);
}
function lightLoad(){
	...
	var light2 = new THREE.DirectionalLight( 0xffff99, 1, 100 );
light2.position.set( 256, 256, 256 );
light2.castShadow = true;            // default false
//Set up shadow properties for the light
light2.shadow.mapSize.width = 512;  // default
light2.shadow.mapSize.height = 512; // default
light2.shadow.camera.near = 0.5;       // default
light2.shadow.camera.far = 2048;      // default
light2.shadow.camera.left = -1024;
light2.shadow.camera.bottom = -1024;
light2.shadow.camera.right = 1024;
light2.shadow.camera.top = 1024;
scene.add( light2 );
...
function onResourcesLoaded(){
	...
	for(var i in meshes){
		...
		meshes[i].castShadow = true; //default is false
meshes[i].receiveShadow = false; //default
		scene.add(meshes[i]);
	}
	for(var i=0;i<50;i++){
		...
		treeBox[i].update();
		meshes[temp].castShadow = true; //default is false
meshes[temp].receiveShadow = false; //default
	...
	weaponBox[0].update();
	meshes["Uzi"].castShadow = true; //default is false
meshes["Uzi"].receiveShadow = false; //default
	...
	weaponBox[1].update();
	meshes["Rocket"].castShadow = true; //default is false
meshes["Rocket"].receiveShadow = false; //default
...
function animate(){
	...
	if(keyboard[32] && player.canShoot <= 0 && player.moveAble==1){
		...
		bullets.push(bullet);
		bullet.castShadow = true; //default is false
	bullet.receiveShadow = false; //default
		scene.add(bullet);
	}
